...
tf.app.flags.DEFINE_string("mode", "train", "Available modes: train / show_examples / official_eval/ tkinter")
...
#for self_attention
tf.app.flags.DEFINE_integer("hidden_size_qp",75,"Hidden size of question passage encoding")
tf.app.flags.DEFINE_integer("hidden_size_pp",75,"Hidden size of passage passage encoding")
tf.app.flags.DEFINE_integer("hidden_size_encoder",200,"Hidden size of encoding")
##################
...
tf.app.flags.DEFINE_bool("co_attention", True, "Perform coattention")
tf.app.flags.DEFINE_bool("simple_attention",False,"Perform the default simple attention")
tf.app.flags.DEFINE_bool("self_attention",False,"Perform self attention")
tf.app.flags.DEFINE_bool("answer_pointer",False,"Use answer pointer network instead of softmax")
tf.app.flags.DEFINE_bool("simple_softmax",True,"Performs simple softmax loss")
tf.app.flags.DEFINE_bool("smart_span",True,"Performs smart span insted of simple argmax")
...
def main(unused_argv):
    ...
    elif FLAGS.mode == "tkinter":
        with tf.Session(config=config) as sess:

            initialize_model(sess, qa_model, bestmodel_dir, expect_exists=True)
            qa_model.show(sess, dev_context_path, dev_qn_path, dev_ans_path, "dev", num_samples=1)
